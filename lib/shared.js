...
function checkConfig(prg, cfg) {
    ...
    if (prg.exitCodeField || cfg.exitCodeField) {
        cfg.exitCodeField = prg.exitCodeField || exitCodeField;
    ...
    if (prg.qualificationId || cfg.QualificationTypeId) {
        ...
        if ('string' !== typeof qualificationId ||
    ...
    cfg.sendNotification = !!(prg.sendNotification || cfg.sendNotification);
    ...
    if (prg.resultsFile || cfg.resultsFile) {
        ...
        logger.info('results file: ' + cfg.resultsFile);
    }
    ...
    if (prg.inputCodesFile || cfg.inputCodesFile) {
        ...
        logger.info('input codes file: ' + cfg.inputCodesFile);
    }
